...
inline void LoadUniform( GLint location, GLfloat v ){
    gl::Uniform1f( location, v );
}
inline void  LoadUniform( GLint location, math::float1 v ){
    gl::Uniform1f( location, v.x );
}
inline void  LoadUniform( GLint location, math::float2 v ){
    gl::Uniform2f( location, v.x, v.y );
}
inline void  LoadUniform( GLint location, math::float3 v ){
    gl::Uniform3f( location, v.x, v.y, v.z );
}
inline void  LoadUniform( GLint location, math::float4 v ){
    gl::Uniform4f( location, v.x, v.y, v.z, v.w );
}
inline void  LoadUniform( GLint location, GLint v ){
    gl::Uniform1i( location, v );
}
inline void  LoadUniform( GLint location, math::int1 v ){
    gl::Uniform1i( location, v.x );
}
inline void  LoadUniform( GLint location, math::int2 v ){
    gl::Uniform2i( location, v.x, v.y );
}
inline void  LoadUniform( GLint location, math::int3 v ){
    gl::Uniform3i( location, v.x, v.y, v.z );
}
inline void  LoadUniform( GLint location, math::int4 v ){
    gl::Uniform4i( location, v.x, v.y, v.z, v.w );
}
inline void  LoadUniform( GLint location, GLuint v ){
    gl::Uniform1ui( location, v );
}
inline void  LoadUniformV( GLint location, GLsizei count, const math::float1* value ){
    gl::Uniform1fv( location, count, value->v );
}
inline void  LoadUniformV( GLint location, GLsizei count, const math::float2* value ){
    gl::Uniform2fv( location, count, value->v );
}
inline void  LoadUniformV( GLint location, GLsizei count, const math::float3* value ){
    gl::Uniform3fv( location, count, value->v );
}
inline void  LoadUniformV( GLint location, GLsizei count, const math::float4* value ){
    gl::Uniform4fv( location, count, value->v );
}
inline void  LoadUniformV( GLint location, GLsizei count, const math::int1* value ){
    gl::Uniform1iv( location, count, value->v );
}
inline void  LoadUniformV( GLint location, GLsizei count, const math::int2* value ){
    gl::Uniform2iv( location, count, value->v );
}
inline void  LoadUniformV( GLint location, GLsizei count, const math::int3* value ){
    gl::Uniform3iv( location, count, value->v );
}
inline void  LoadUniformV( GLint location, GLsizei count, const math::int4* value ){
    gl::Uniform4iv( location, count, value->v );
}
inline void  LoadUniformV1( GLint location, GLsizei count, const GLuint* value ){
    gl::Uniform1uiv( location, count, value );
}
inline void  LoadUniformV2( GLint location, GLsizei count, const GLuint* value ){
    gl::Uniform2uiv( location, count, value );
}
inline void  LoadUniformV3( GLint location, GLsizei count, const GLuint* value ){
    gl::Uniform3uiv( location, count, value );
}
inline void  LoadUniformV4( GLint location, GLsizei count, const GLuint* value ){
    gl::Uniform4uiv( location, count, value );
}

inline void  LoadUniformMatrix4x4( GLint location, GLboolean transpose, const math::float4x4 value ){
    UniformMatrix4fv( location, 1, transpose, &(value.m[0][0]) );
}


inline void  LoadUniformMatrix2x2V( GLint location, GLsizei count, GLboolean transpose, const GLfloat* value ){
    UniformMatrix2fv( location, count, transpose, value );
}
inline void  LoadUniformMatrix3x3V( GLint location, GLsizei count, GLboolean transpose, const GLfloat* value ){
    UniformMatrix3fv( location, count, transpose, value );
}
inline void  LoadUniformMatrix4x4V( GLint location, GLsizei count, GLboolean transpose, const GLfloat* value ){
    UniformMatrix4fv( location, count, transpose, value );
}
inline void  LoadUniformMatrix4x4V( GLint location, GLsizei count, GLboolean transpose, const math::float4x4* value ){
